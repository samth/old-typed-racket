(module 660-env mzscheme
  ...
  (provide initial-env initialize-others initial-type-names)
  ...
  (define initial-env
    (let ([make-lst make-Listof]
      ...
      (make-env
       ...
       [660:list? (make-pred-ty (-lst Univ))]
       [list (-poly (a) (->* '() a (-lst a)))]
